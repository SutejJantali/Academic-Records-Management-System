...
function sendOTP($email,$otp) 
{
		...
		$mail->Username = "arunahunasigi@gmail.com";  // enter email address from which you want to send otp to user
 		$mail->Password = "wbaycrmyuasziktf";  	// enter password here for the email-id provided
 
		$mail->SMTPDebug = 0;
		$mail->SetFrom("arunahunasigi@gmail.com", "Admin@");
